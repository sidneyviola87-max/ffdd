...
import { Home, MessageCircle, PlusCircle, Bell, Search } from "lucide-react";
...
export default function BottomNav() {
  ...
  const navItems = [
    ...
    { href: "/chat", icon: MessageCircle, label: "Chats", badge: unreadMessages },
    { href: "/notifications", icon: Bell, label: "Alerts", badge: unreadNotifications },
  ];

  return (
    <div className="fixed bottom-0 left-0 right-0 bg-background border-t border-border px-2 py-2 flex justify-between items-center z-50 md:hidden">
      {navItems.map((item) => {
